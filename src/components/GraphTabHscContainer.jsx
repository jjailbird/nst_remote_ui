        ...
        <div className="graphType">
          ...
          <div className="graphTypeContents">
            <div className={type !== 'PIE' ? 'hide' : ''}>
              <DonutDigitalChart data={data.sylinder} shift="25" max="50" unit="mm" name="CYLINDER STROKE" strokeColor="#8cb857" strokeColorLine="#2f4036"/>
            ...
            <div className={type != 'BAR' ? 'hide' : ''}>
              <DynamicBarChart data={data.sylinder} shift="25" max="50" unit="mm" name="CYLINDER STROKE" barColor="#6f934f"/>
            ...
            <div className={type != 'LINE' ? 'hide' : ''}>
              <DynamicLineChart data={data.sylinder} shift="25" max="50" unit="mm" name="CYLINDER STROKE"/>
