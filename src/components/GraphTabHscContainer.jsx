        ...
        <div className="graphType">
          ...
          <div className="graphTypeContents">
            <div className={type !== 'PIE' ? 'hide' : ''}>
              ...
              <DonutDigitalChart data={data.aPort} max="500" unit="kpa" name="a port pressure" strokeColor="#3581c9" strokeColorLine="#16315b"/>
              <DonutDigitalChart data={data.bPort} max="500" unit="kpa" name="b port pressure" strokeColor="#3581c9" strokeColorLine="#16315b"/>
            </div>
            <div className={type != 'BAR' ? 'hide' : ''}>
              ...
              <DynamicBarChart data={data.aPort} max="500" unit="kpa" name="a port pressure" barColor="#2c68a8"/>
              <DynamicBarChart data={data.bPort} max="500" unit="kpa" name="b port pressure" barColor="#2c68a8"/>
            </div>
            <div className={type != 'LINE' ? 'hide' : ''}>
              ...
              <DynamicLineChart data={data.aPort} max="500" unit="kpa" name="a port pressure" />
              <DynamicLineChart data={data.bPort} max="500" unit="kpa" name="b port pressure" />              
            </div>
