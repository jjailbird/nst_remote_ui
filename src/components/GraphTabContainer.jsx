        ...
        <div className="graphType">
          ...
          <div className="graphTypeContents">
            <div className={type !== 'PIE' ? 'hide' : ''}>
              <DonutDigitalChart data={data.latDistance} shift="20" max="40" unit="mm" name="lat. distance" strokeColor="#8cb857" strokeColorLine="#2f4036"/>
              <DonutDigitalChart data={data.yawAngle} shift="15" max="30" unit="deg" name="yaw angle" strokeColor="#8cb857" strokeColorLine="#2f4036"/>
              <DonutDigitalChart data={data.motorTorque} max="500" unit="Nm" name="motor torque" strokeColor="#3581c9" strokeColorLine="#16315b"/>
              <DonutDigitalChart data={data.motorSpeed} max="500" unit="RPM" name="motor speed" strokeColor="#3581c9" strokeColorLine="#16315b"/>
            </div>
            <div className={type != 'BAR' ? 'hide' : ''}>
              <DynamicBarChart data={data.latDistance} shift="20" max="40" unit="mm" name="lat. distance" barColor="#6f934f"/>
              <DynamicBarChart data={data.yawAngle} shift="15" max="30" unit="deg" name="yaw angle" barColor="#6f934f"/>
              <DynamicBarChart data={data.motorTorque} max="500" unit="Nm" name="motor torque" barColor="#2c68a8"/>
              <DynamicBarChart data={data.motorSpeed} max="500" unit="RPM" name="motor speed" barColor="#2c68a8"/>
            </div>
